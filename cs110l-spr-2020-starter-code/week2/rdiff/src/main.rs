...
fn lcs(seq1: &Vec<String>, seq2: &Vec<String>) -> Grid {
    ...
    let mut C: Grid = Grid::new(len_seq1 + 1, len_seq2 + 1);

    for i in 0..len_seq1+1 {
        C.set(i, 0, 0).expect("first set");
    };
...
fn main() {
    ...
    print_diff(&lcs_grid, &file_1_lines, &file_2_lines, file_1_lines.len(), file_2_lines.len());
